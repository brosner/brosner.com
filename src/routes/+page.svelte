        ...
        <div class="navbar-end">
          <div class="navbar-item">
            <div class="field is-grouped">
              <p class="control">
                <a href="https://github.com/brosner" class="button is-dark">
                  <span class="icon">
                    <svg version="1.1" role="presentation" width="17.82857142857143" height="20.8" viewBox="0 0 1536 1792" class="fa-icon" style="font-size: 1.3em;">
                      <path
              ...
              <p class="control">
                <a href="https://www.threads.net/@brosner" class="button is-info">
                  <span class="icon">
                    <svg version="1.1" role="presentation" width="19.314285714285717" height="20.8" viewBox="0 0 1664 1792" class="fa-icon" style="font-size: 1.3em;">
                      <path
